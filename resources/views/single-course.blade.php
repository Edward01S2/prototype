    ...
    <div class="course-container">
      <div class="course-meta bg-p-blue-200 text-white">
        <div class="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
          <div class="md:w-1/2 md:mr-auto md:ml-0 lg:flex lg:items-center xl:w-2/3">
            <div class="w-1/3 mx-auto py-4 pb-8 md:hidden lg:block lg:order-2 xl:w-1/4">
              {!! the_post_thumbnail() !!}
            </div>
            <div class="text-center lg:order-1 md:text-left md:py-8 lg:py-0">
              ...
              <h2 class="uppercase font-semibold tracking-wider text-4xl py-1 leading-none text-white mb-0 md:py-2 lg:py-4 xl:text-5xl">{!! get_the_title() !!}</h2>
